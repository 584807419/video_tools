...
from film_search.views import FilmSearch, FilmDownload, FilmOnlineLookup, FilmOnlineLookupUrl
...
urlpatterns = [
    ...
    path('film_onlinelook_url/', FilmOnlineLookupUrl.as_view(), name="film_onlinelook_url"),
]
